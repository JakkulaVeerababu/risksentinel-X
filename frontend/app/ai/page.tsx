...
export default function AIHubPage() {
  return (
    <div className="rsx-page space-y-5">
      <PageHeader eyebrow="Investigation intelligence" title="Investigation AI" description="Move from signal to an evidence-backed decision without leaving the case context. Seeded demo data." />
