      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-label-sm text-text-secondary font-medium">
            Manage fraud cases and alerts generated by the Risk Engine.
          </p>
        </div>
        <div className="flex flex-wrap items-center gap-3">
          <button className="bg-surface hover:bg-surface-secondary text-text-primary px-5 py-2.5 rounded-xl text-label-sm font-semibold transition-all border border-border shadow-sm flex items-center gap-2">
            Export Report
          </button>
        </div>
      </div>
