...
const capabilities = [
  ...
  },
  {
    ...
    tone: "from-[#052c2b] via-[#07544a] to-[#08756a]",
  },
];
    ...
    <div className="min-h-screen overflow-x-hidden bg-[#f7f9ff] text-[#071632]">
      <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-[#071229]/90 backdrop-blur-2xl">
        <div className="mx-auto flex h-[76px] max-w-[1440px] items-center px-5 sm:px-8 lg:px-12">
          <div className="rounded-xl bg-white px-3 py-1.5 shadow-[0_8px_28px_rgba(0,0,0,.18)]">
            <BrandLogo />
          </div>
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="mt-9 flex flex-wrap gap-x-5 gap-y-3">
                {trustPoints.map((item) => (
                  <span key={item} className="flex items-center gap-2 text-[12px] font-semibold text-[#94a4c1]"><Check className="h-3.5 w-3.5 text-[#66e0b7]" />{item}</span>
                ))}
              </div>
            </div>
            ...
            <div className="relative flex min-h-[530px] items-center justify-center lg:min-h-[620px]">
              ...
              <div className="relative w-full max-w-[700px] overflow-hidden rounded-[26px] border border-white/15 bg-[#0b1833]/95 shadow-[0_36px_100px_rgba(0,0,0,.48)]">
                <div className="flex h-14 items-center border-b border-white/10 px-5">
                  <div className="flex gap-1.5"><span className="h-2.5 w-2.5 rounded-full bg-[#ff6b6b]" /><span className="h-2.5 w-2.5 rounded-full bg-[#ffc145]" /><span className="h-2.5 w-2.5 rounded-full bg-[#32d583]" /></div>
                  <span className="ml-5 text-[11px] font-bold uppercase tracking-[.16em] text-[#7f91b2]">Live risk command center</span>
                  <span className="ml-auto inline-flex items-center gap-1.5 rounded-full bg-[#123a31] px-2.5 py-1 text-[10px] font-bold text-[#63e6b6]"><span className="h-1.5 w-1.5 rounded-full bg-[#35d9a2]" />Operational</span>
                </div>
                <div className="grid gap-px bg-white/10 sm:grid-cols-[1fr_220px]">
                  <div className="bg-[#0a152d] p-5 sm:p-6">
                    ...
                    <div className="relative mt-7 h-[278px] overflow-hidden rounded-2xl border border-white/10 bg-[#071126] [background-image:linear-gradient(rgba(91,129,255,.06)_1px,transparent_1px),linear-gradient(90deg,rgba(91,129,255,.06)_1px,transparent_1px)] [background-size:32px_32px]">
                      <svg className="absolute inset-0 h-full w-full" viewBox="0 0 520 280" aria-hidden="true">
                        ...
                        <g><circle cx="255" cy="145" r="34" fill="#e74440" stroke="#ffc7c4" strokeWidth="4" /><circle cx="105" cy="70" r="22" fill="#356df0" stroke="#a9c0ff" strokeWidth="3" /><circle cx="115" cy="225" r="22" fill="#19a776" stroke="#8ff0ce" strokeWidth="3" /><circle cx="405" cy="65" r="22" fill="#7b4ee8" stroke="#cbb7ff" strokeWidth="3" /><circle cx="410" cy="218" r="22" fill="#d68516" stroke="#ffd18a" strokeWidth="3" /></g>
                      </svg>
                      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 translate-y-8 text-center"><p className="text-[11px] font-bold text-white">TX C9000</p><p className="text-[9px] text-[#9aa9c4]">Blocked · score 94</p></div>
                      <div className="absolute left-[10%] top-[7%] text-[9px] font-semibold text-[#bac7dc]">Device 8812</div>
                      <div className="absolute bottom-[7%] right-[7%] text-[9px] font-semibold text-[#bac7dc]">Card •8219</div>
                    </div>
                  </div>
                  <div className="bg-[#101d38] p-5">
                    ...
                    <div className="mt-5 space-y-4">
                      {[['Entity risk','94'],['Linked identities','11'],['Policy confidence','97%']].map(([label,value]) => <div key={label} className="border-b border-white/10 pb-3"><p className="text-[9px] font-bold uppercase tracking-[.1em] text-[#6f81a2]">{label}</p><p className="mt-1 text-[15px] font-semibold text-white">{value}</p></div>)}
                    </div>
              ...
              <div className="absolute bottom-[2%] left-0 hidden w-[220px] rounded-2xl border border-white/15 bg-white/10 p-4 shadow-2xl backdrop-blur-xl sm:block">
                <p className="text-[10px] font-bold uppercase tracking-[.12em] text-[#a7b5ce]">Loss prevented today</p><p className="mt-2 text-[26px] font-semibold tracking-[-.035em]">₹18.4L</p><p className="mt-1 text-[10px] font-semibold text-[#62e3b3]">↑ 16.8% vs yesterday</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="outcomes" className="bg-white py-20 sm:py-28">
          <div className="mx-auto max-w-[1280px] px-5 sm:px-8">
            <div className="rounded-[32px] bg-[#071229] px-6 py-14 text-center text-white shadow-[0_30px_90px_rgba(7,18,41,.22)] sm:px-12 sm:py-20">
              ...
              <p className="mx-auto mt-5 max-w-[620px] text-[16px] leading-7 text-[#9facc4]">No credentials. No setup. Start from the live operations dashboard and explore every workflow.</p>
