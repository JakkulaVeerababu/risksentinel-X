...
const accessPoints = [
  ["Live decisions", "Monitor allow, review and block outcomes"],
...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-[100dvh] w-full overflow-x-hidden bg-[#06132c] p-0 sm:p-4 xl:p-6">
      <div className="grid min-h-[100dvh] w-full overflow-hidden bg-white sm:min-h-[calc(100dvh-32px)] sm:rounded-[28px] sm:border sm:border-white/15 sm:shadow-[0_36px_110px_rgba(0,0,0,.4)] lg:grid-cols-[1.16fr_.84fr] xl:min-h-[calc(100dvh-48px)]">
        <section className="relative hidden min-h-0 overflow-hidden bg-[#071633] px-10 py-9 text-white lg:flex lg:flex-col xl:px-14 xl:py-11 2xl:px-16">
          ...
          <div className="relative z-10 inline-flex w-fit rounded-xl bg-white px-3 py-1.5 shadow-[0_12px_36px_rgba(0,0,0,.22)]"><BrandLogo /></div>
          ...
          <div className="relative z-10 my-auto max-w-[760px] py-8">
            ...
            <div className="mt-8 overflow-hidden rounded-[22px] border border-white/12 bg-[#0b1b3b]/86 shadow-[0_24px_70px_rgba(0,0,0,.28)] backdrop-blur-xl">
              ...
              <div className="flex items-center justify-between border-t border-white/10 px-5 py-3.5 text-[11px] font-semibold text-[#8fa1c1]"><span>Graph + ML + policy evidence synchronized</span><span className="text-[#55d9aa]">Operational</span></div>
            </div>
          </div>
        ...
        <section className="relative flex min-h-[100dvh] min-w-0 flex-col bg-[#fbfcff] px-6 py-6 sm:min-h-[calc(100dvh-32px)] sm:px-10 sm:py-8 lg:min-h-0 xl:min-h-[calc(100dvh-48px)] xl:px-14 2xl:px-16">
          <div className="flex items-center justify-between">
            <div className="rounded-xl border border-[#e4e9f1] bg-white px-2 py-1 shadow-sm lg:hidden"><BrandLogo /></div>
          ...
          <div className="my-auto mx-auto w-full max-w-[500px] py-8">
            ...
            <h2 className="balance mt-4 text-[38px] font-semibold leading-[1.04] tracking-[-.05em] text-[#071936] sm:text-[46px] xl:text-[52px]">Enter the live risk workspace.</h2>
            ...
            <div className="mt-5 flex items-center justify-between gap-4 text-[10px] font-semibold text-[#8a95a7]"><span>17 operational workspaces</span><span className="text-[#168d68]">All engines online</span></div>
          </div>
