      ...
      <section className="rsx-blueprint rsx-editorial-grid relative overflow-hidden rounded-[10px] border border-[#d7ded9] px-5 py-6 text-[#111a2d] sm:px-7">
        <div className="relative flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          <div className="max-w-2xl">
            <p className="text-[9px] font-black uppercase tracking-[.18em] text-[#315efb]">Operations intelligence brief</p>
            <h2 className="mt-2 balance text-[21px] font-semibold tracking-[-.035em] sm:text-[25px]">
              {pending.length} pending recommendations available for review.
            </h2>
            <p className="mt-2 text-[11px] leading-5 text-[#5f6b80]">
              Recommendations are dynamically generated by Investigation AI based on active cases.
            </p>
          </div>
          <div className="grid shrink-0 grid-cols-3 border border-[#cbd4ce] bg-white/75 md:w-[315px]">
            {[
              ...
              <div key={label} className={`px-3 py-3 ${index ? "border-l border-[#d6ddd8]" : ""}`}>
              ...
              <article key={item.id} className={`rsx-card overflow-hidden transition-all ${status ? "opacity-70" : "rsx-card-interactive"}`}>
                <div className="grid lg:grid-cols-[minmax(0,1fr)_220px]">
                  ...
                  <aside className="flex flex-col justify-between border-t border-[#edf0f5] bg-[#fafbfd] p-5 lg:border-l lg:border-t-0">
                    <div>
                      <p className="text-[10px] font-extrabold uppercase tracking-[.12em] text-[#8b95a7]">Illustrative impact</p>
