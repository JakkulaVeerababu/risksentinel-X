...
# Test F: Simulate APP_ENV=production, AGENT_PROVIDER=missing
# This should cause InvestigationService to degrade smoothly when investigate() is called.
...
print("===== TEST F: Provider Missing Outage (DEGRADED PIPELINE) =====")
...
assert data["policy"]["decision"] == "REVIEW"
print("TEST F PASSED: Agent successfully degraded without crashing, policy finalized.")
