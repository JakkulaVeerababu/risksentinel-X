...
if __name__ == "__main__":
    ...
    # Case A
    test_case("CASE A: FABRICATED EVIDENCE", "9100001", {
    ...
    # Case B
    test_case("CASE B: WRONG SOURCE", "9100002", {
    ...
    # Case C
    test_case("CASE C: MIXED EVIDENCE", "9100003", {
        "recommendation": "REVIEW",
        "confidence": 0.8,
        "reason_codes": ["UNUSUAL_AMOUNT"],
        "evidence": [
    ...
    # Case D
    test_case("CASE D: INVALID SOURCE", "9100004", {
        "recommendation": "REVIEW",
        "confidence": 0.8,
        "reason_codes": ["UNUSUAL_AMOUNT"],
        "evidence": [
    ...
    # Case E
    test_case("CASE E: BLOCK 0.99 + UNSUPPORTED EVIDENCE", "9100005", {
        "recommendation": "BLOCK",
        "confidence": 0.99,
        "reason_codes": ["UNUSUAL_AMOUNT"],
        "evidence": [
